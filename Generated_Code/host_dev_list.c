...
/*
** ===================================================================
**     Method      :  usb_dev_list_attach_device (component USB_HOST_STACK)
**     Description :
**         This function will be called when attach interrupt happens,
**         to add onto the device list and do common initialization.
**     Parameters  :
**         NAME            - DESCRIPTION
**         handle          - 
**         speed           - 
...
** ===================================================================
*/
USB_STATUS usb_dev_list_attach_device(_usb_host_handle handle, uint_8 speed, uint_8 hub_no, uint_8 port_no)
{
    /* Body */
    USB_STATUS                 status;
