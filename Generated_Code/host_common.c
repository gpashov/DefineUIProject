...
/*
** ===================================================================
**     Method      :  usb_hostdev_validate (component USB_HOST_STACK)
**     Description :
**         Function to verify pointer is address of an instance on
**         device list. It is presumed that this function is called
**         with USB interrupts disabled
**     Parameters  :
**         NAME            - DESCRIPTION
**         device_handle   - 
**     Returns     :
...
** ===================================================================
*/
USB_STATUS usb_hostdev_validate(_usb_device_instance_handle device_handle)
{
    DEV_INSTANCE_PTR           dev_ptr = (DEV_INSTANCE_PTR)device_handle;
    USB_HOST_STATE_STRUCT_PTR  usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)dev_ptr->host;
    DEV_INSTANCE_PTR           test_ptr = (DEV_INSTANCE_PTR)usb_host_ptr->DEVICE_LIST_PTR;
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_get_buffer (component USB_HOST_STACK)
**     Description :
...
**     Parameters  :
**         NAME            - DESCRIPTION
**         dev_handle      - [IN] the device instance
**         buffer_size     - [IN] buffer size to get
**       * buff_ptr        - [OUT] pointer to the buffer, or
**                           NULL
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_hostdev_get_buffer(_usb_device_instance_handle dev_handle, uint_32 buffer_size, uchar_ptr _PTR_ buff_ptr)
{
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_get_descriptor (component USB_HOST_STACK)
**     Description :
**         If the intf_handle is NULL, then the descriptor is searched
**         within the whole device. If the intf_handle is not NULL, the
**         descriptor is  searched within specified interface (ignored
**         if desc_type is  USB_DESC_TYPE_DEV, USB_DESC_TYPE_CFG or
**         USB_DESC_TYPE_IF and required  for USB_DESC_TYPE_EP).
**     Parameters  :
**         NAME            - DESCRIPTION
**         dev_handle      - [IN] the device instance
**         intf_handle     - [IN] the device instance
**                           or NULL to search the device config
**         desc_type       - 
**         desc_index      - [IN] the index of desc_type
**                           decriptor, or 0
**         intf_alt        - [IN] the interface alternate, or
**                           0
**       * descriptor      - [OUT] handle of the
**                           descriptor, or NULL
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_hostdev_get_descriptor(_usb_device_instance_handle dev_handle, _usb_interface_descriptor_handle intf_handle, descriptor_type desc_type, uint_8 desc_index, uint_8 intf_alt, void* _PTR_ descriptor)
{
    DEV_INSTANCE_PTR  dev_ptr;
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_find_pipe_handle (component USB_HOST_STACK)
**     Description :
...
** ===================================================================
*/
_usb_pipe_handle _usb_hostdev_find_pipe_handle(_usb_device_instance_handle dev_handle, _usb_interface_descriptor_handle intf_handle, uint_8 pipe_type, uint_8 pipe_direction)
{
    /* Body */
    DESCRIPTOR_UNION           desc;
    DEV_INSTANCE_PTR           dev_ptr;
...
/*
** ===================================================================
**     Method      :  usb_hostdev_get_pipe_handle (component USB_HOST_STACK)
**     Description :
**         Function to map a particular pipe type and direction in the
**         given bundle (which contains device/interface). It is
**         presumed that this function is called with USB interrupts
**         disabled
**     Parameters  :
**         NAME            - DESCRIPTION
**         pbs_ptr         -  pointer to pipe bundle struct
**         pipe_type       - Pipe type = one of:
**                           USB_ISOCHRONOUS_PIPE
**                           USB_INTERRUPT_PIPE
**                           USB_CONTROL_PIPE
**                           USB_BULK_PIPE
**         pipe_direction  - Pipe direction
**                           (ignored for control pipe) = one of:
**                           USB_RECV
**                           USB_SEND
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
_usb_pipe_handle usb_hostdev_get_pipe_handle(PIPE_BUNDLE_STRUCT_PTR pbs_ptr, uint_8 pipe_type, uint_8 pipe_direction)
{
    /* Body */
...
/*
** ===================================================================
**     Method      :  usb_host_class_intf_init (component USB_HOST_STACK)
**     Description :
**         Initialize header of class interface info struct. Incoming
**         params are checked to catch errors early before attempts to
**         use the struct.
**     Parameters  :
**         NAME            - DESCRIPTION
**         pbs_ptr         -  [IN] device/descriptor/pipe
**                           handles
**       * class_intf_handle - [IN]
**                           class-interface handle 
**       * anchor_ptr      - [IN] address of class's
**                           instance list anchor
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS usb_host_class_intf_init(PIPE_BUNDLE_STRUCT_PTR pbs_ptr, void* class_intf_handle, void* anchor_ptr)
{
    /* Body */
...
/*
** ===================================================================
**     Method      :  usb_host_class_intf_validate (component USB_HOST_STACK)
**     Description :
**         It is presumed that this function is called with interrupts
**         disabled
**     Parameters  :
**         NAME            - DESCRIPTION
**       * class_intf_handle - [IN]
...
** ===================================================================
*/
uint_32 usb_host_class_intf_validate(void* class_intf_handle)
{
    /* Body */
...
/*
** ===================================================================
**     Method      :  _usb_host_driver_info_register (component USB_HOST_STACK)
**     Description :
**         Function to register user's desired-interfaces array of
**         structs.
**     Parameters  :
**         NAME            - DESCRIPTION
**         host_handle     - usb host
**       * info_table_ptr  - Device info table
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_host_driver_info_register(_usb_host_handle host_handle, void* info_table_ptr)
{
    USB_HOST_STATE_STRUCT_PTR host_struct_ptr;
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_select_config (component USB_HOST_STACK)
**     Description :
**         Function to tear down an old configuration, and set up a new
**         configuration with the same or different index.
**     Parameters  :
**         NAME            - DESCRIPTION
...
** ===================================================================
*/
USB_STATUS _usb_hostdev_select_config(_usb_device_instance_handle dev_handle, uint_8 config_no)
{
    USB_STATUS              error;
...
/*
** ===================================================================
**     Method      :  _usb_hostdev_select_interface (component USB_HOST_STACK)
**     Description :
**         Function to tear down old interface, and set up a new one
**         with the same or different index/alternate. For each
**         interface, only one of its alternates  can be selected per
**         USB spec.  Also per spec, an endpoint  can be in only one
**         interface (though it may exist in  several alternates of
**         that interface).
**     Parameters  :
**         NAME            - DESCRIPTION
**         dev_handle      - [IN] USB device
**         intf_handle     - [IN] Interface to be
**                           selected
**       * class_intf_ptr  - [OUT] Initialized
**                           class-specific interface struct
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_hostdev_select_interface(_usb_device_instance_handle dev_handle, _usb_interface_descriptor_handle intf_handle, void* class_intf_ptr)
{
    /* Body */
...
/*
** ===================================================================
**     Method      :  usb_hostdev_tr_init (component USB_HOST_STACK)
**     Description :
**         
**     Parameters  :
**         NAME            - DESCRIPTION
**         tr_ptr          - [OUT] initialized
**                           TR_INIT_PARAM_STRUCT
**         callback        - [IN] callback to call after
**                           completion
**       * callback_param  - [IN] the param to
**                           pass back to the callback function
**     Returns     : Nothing
** ===================================================================
*/
void usb_hostdev_tr_init(TR_INIT_PARAM_STRUCT_PTR tr_ptr, tr_callback callback, void* callback_param)
{
    USB_lock();
