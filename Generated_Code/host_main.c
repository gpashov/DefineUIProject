...
/*
** ===================================================================
**     Method      :  _usb_host_init (component USB_HOST_STACK)
**     Description :
**         Initializes the USB hardware and installs the USB interrupt
**         handler
**     Parameters  :
**         NAME            - DESCRIPTION
**         devnum          - [IN] device number
**         frame_list_size - [IN] maximum
**                           number of Pipes
**       * hci_handle      - Pointer to [OUT] the USB
**                           host handle
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_host_init(uint_8 devnum, uint_32 frame_list_size, _usb_host_handle _PTR_ hci_handle)
{
    /* Body */
    USB_STATUS error;
...
/*
** ===================================================================
**     Method      :  _usb_host_register_service (component USB_HOST_STACK)
**     Description :
**         Registers a callback routine for a specified event.
**     Parameters  :
**         NAME            - DESCRIPTION
**         hci_handle      - [IN] Handle to the USB device
**         type            - [IN] type of event or endpoint number to
**                           service
**         service         - [IN] Pointer to the service's
**                           callback function
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
uint_32 _usb_host_register_service(_usb_host_handle hci_handle, uint_8 type, SERVICE_CALLBACK service)
{
...
/*
** ===================================================================
**     Method      :  _usb_host_unregister_service (component USB_HOST_STACK)
**     Description :
**         Unregisters a callback routine for a specified event or
**         endpoint.
**     Parameters  :
**         NAME            - DESCRIPTION
**         hci_handle      - [IN] USB Host controller
**                           handle
**         event           - [IN] Service to unregister
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
uint_32 _usb_host_unregister_service(_usb_host_handle hci_handle, uint_8 event)
{
    /* Body */
    USB_HOST_STATE_STRUCT_PTR           usb_host_ptr;
    USB_SERVICE_STRUCT_PTR              service_ptr;
...
{ /* Body */
    ...
    pipe_descr_ptr->tr_list_ptr = temp->next;
    free((pointer)temp);
    }
...
/*
** ===================================================================
**     Method      :  _usb_host_open_pipe (component USB_HOST_STACK)
**     Description :
**          _usb_host_open_pipe routine initializes a new pipe
**         descriptor and  returns USB_OK or error and the pipe
**         descriptor for the USB bus address,  endpoint number,
**         direction of transfer, maximum packet size, interval  and
**         the type of pipe
**     Parameters  :
**         NAME            - DESCRIPTION
**         hci_handle      - [IN] the USB Host state
**                           structure
**         pipe_init_params_ptr - [IN]
**                           Pipe initialization parameters
**       * pipe_handle     - [OUT] Pipe handle
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
USB_STATUS _usb_host_open_pipe(_usb_host_handle hci_handle, PIPE_INIT_PARAM_STRUCT_PTR pipe_init_params_ptr, _usb_pipe_handle *pipe_handle)
{
    /* Body */
    PIPE_DESCRIPTOR_STRUCT_PTR pipe_descr_ptr;
...
/*
** ===================================================================
**     Method      :  _usb_host_send_setup (component USB_HOST_STACK)
**     Description :
**         Sends a Setup packet. Internally, following the SendSetup
**         call this takes care of the whole transaction (including
**         receiving or sending any data to or from the device).
**     Parameters  :
**         NAME            - DESCRIPTION
**         hci_handle      - [IN] the USB Host state
**                           structure 
...
** ===================================================================
*/
uint_32 _usb_host_send_setup(_usb_host_handle hci_handle, _usb_pipe_handle pipe_handle, TR_INIT_PARAM_STRUCT_PTR tr_params_ptr)
{
    /* Body */
    PIPE_TR_STRUCT_PTR         pipe_tr_ptr;
    PIPE_DESCRIPTOR_STRUCT_PTR pipe_descr_ptr;
...
/*
** ===================================================================
**     Method      :  _usb_host_get_transfer_status (component USB_HOST_STACK)
**     Description :
**         _usb_host_get_transfer_status is a routine that returns
**         status of a transfer. 
**     Parameters  :
**         NAME            - DESCRIPTION
**         pipe_handle     - [IN] the pipe handle
**         transfer_number - [IN] Specific
**                           transfer number on the pipe
**     Returns     :
**         ---             - Error code
** ===================================================================
*/
uint_32 _usb_host_get_transfer_status(_usb_pipe_handle pipe_handle, uint_32 transfer_number)
{
    /* Body */
    PIPE_DESCRIPTOR_STRUCT_PTR pipe_descr_ptr;
